...
int main(int argc, char* argv[]){
    ...
    if (argc != NUMBER_PARAMETERS){
        ...
        // Photon list to store photons in first place
        ...
        // Calculate direct light (ray tracing)
        rayTracer(PPP, width, height, img, planeList, sphereList, triangleList, directLightList,
